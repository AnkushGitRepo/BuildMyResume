      ...
      {!showOtpInput ? (
        <form onSubmit={handleSignUp}>
          ...
          <div className="inputForm">
            <svg height={20} viewBox="-64 0 512 512" width={20} xmlns="http://www.w3.org/2000/svg"><path d="M224 256A128 128 0 1 0 224 0a128 128 0 1 0 0 256zm-45.7 48C79.8 304 0 383.8 0 482.3C0 498.7 13.3 512 29.7 512H418.3c16.4 0 29.7-13.3 29.7-29.7C448 383.8 368.2 304 269.7 304H178.3z" /></svg>
            <input
              type="text"
              className="input"
          ...
          <p className="p">Already an account? <span className="span" onClick={() => setCurrentPage("login")}>Login</span>
        ...
        <form onSubmit={handleVerifyOtp}>
          ...
          <button className="button-submit" type="submit">Verify OTP</button>
        </form>
      )}
    </div>
  );
